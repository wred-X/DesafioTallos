  ...
  <div class="container" @submit.prevent>
    <nav class="collapse navbar-collapse" role="navigation">
      <ul class="nav navbar-nav">
        ...
        <RouterLink @click="submitEditUser(this.$store.state.user.id)" style="align-self: center; font-size: 18px; font-weight: bold;" to="/editor">Editar meu perfil</RouterLink>
        </ul>
